...
define('SC_DIR_ROOT', dirname(__FILE__));

require_once 'sc_includes/config.php';
require_once 'sc_libraries/securimage/securimage.php';

session_name(md5(SC_URL_HOME));
...
$img->ttf_file = 'sc_libraries/securimage/AHGBold.ttf';
