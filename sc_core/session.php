 ...
 * @package sc_core
 * @method static SC_Session getInstance()
 * @since 1.0
 */
class SC_Session
{
    ...
    public function start()
    {
        ...
        {
            $_SESSION['session.home_url'] = SC_URL_HOME;
        }
        else if ( strcmp($_SESSION['session.home_url'], SC_URL_HOME) )
        {
            $this->regenerate();
        }

        $userAgent = SC::getRequest()->getUserAgentName();
