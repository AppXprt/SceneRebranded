 ...
 * @since 1.0
 */
final class SC_Database
{
    //const DEFAULT_CACHE_LIFETIME = false;
    const NO_CACHE_ENTRY = "sc_db_no_cache_entry";
    ...
    private function execute( $sql, array $params = null )
    {
        ...
        SC::getEventManager()->trigger(new SC_Event("core.sql.exec_query", array("sql" => $sql, "params" => $params)));
    ...
    {
        return !SC_DEV_MODE && $this->useCashe && ( $expTime === false || $expTime > 0 );
    }
    ...
    private function getFromCache( $sql, $params, $cacheLifeTime )
    {
        ...
        $data = SC::getEventManager()->call("core.sql.get_query_result", array("sql" => $sql, "params" => $params));
    ...
    private function saveToCache( $result, $sql, $params, $cacheLifeTime, $tags )
    {
        ...
        SC::getEventManager()->trigger(new SC_Event("core.sql.set_query_result",
