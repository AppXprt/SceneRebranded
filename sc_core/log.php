...
class SC_Log
{
     ...
     *
     * @param string $type
     * @param SC_LogWriter $logWriter
     */
    private function __construct( $type )
    {
        $this->type = $type;
        $this->logWriter = new BASE_CLASS_DbLogWriter();
        SC::getEventManager()->bind('core.exit', array($this, 'writeLog'));
        SC::getEventManager()->bind('core.emergency_exit', array($this, 'writeLog'));
    }
     ...
     * @param SC_LogWriter $logWriter
     */
    public function setLogWriter( SC_LogWriter $logWriter )
    {
