 ...
 * @package sc_core
 * @method static SC_CacheManager getInstance()
 * @since 1.0
 */
class SC_CacheManager
{
    use SC_Singleton;
    ...
    /**
     * @param SC_ICacheBackend $cacheBackend
     */
    public function setCacheBackend( SC_ICacheBackend $cacheBackend )
    {
