...
final class SC_ErrorManager
{
    ...
    public function setLogger( SC_Log $logger )
    {
        $this->logger = $logger;
    }
    ...
    private function handleDie( $data )
    {
        ...
        SC::getEventManager()->trigger(new SC_Event('core.emergency_exit', $data));
        exit;
    }
    ...
    private function handleRedirect( $data )
    {
        ...
        header('Location: ' . SC_URL_HOME . 'e500.php');
    }
