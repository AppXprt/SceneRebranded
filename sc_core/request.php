 ...
 * @package sc_core
 * @method static SC_Request getInstance()
 * @since 1.0
 */
class SC_Request
{
    ...
    public function getRequestUri()
    {
        if ( $this->uri === null )
        {
            $this->uri = UTIL_Url::getRealRequestUri(SC::getRouter()->getBaseUrl(), $_SERVER['REQUEST_URI']);
        }
...
//    }
    ...
    {
        $url = ( $url === null ) ? SC_URL_HOME . $this->getRequestUri() : trim($url);
