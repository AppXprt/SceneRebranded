 ...
 * @since 1.0
 */
class SC_HtmlDocument extends SC_Document
{
     ...
     *
     * @param SC_MasterPage $masterPage
     * @return SC_HtmlDocument
     */
    public function setMasterPage( SC_MasterPage $masterPage )
    {
    ...
    public function addScriptDeclaration( $script, $type = "text/javascript", $priority = null )
    {
        ...
        $event = new SC_Event('core.onAddScriptDeclaration', ['scriptHash' => $scriptHash, 'type' => $type], $script);
    ...
    public function render()
    {
        ...
        {
            $this->setTemplate(SC::getThemeManager()->getMasterPageTemplate('html_document'));
        }
        ...
        $assignArray = array(
            ...
            'pageBody' => $this->prependCode . $masterPageOutput . $this->appendCode . $jsData . SC_Document::APPEND_PLACEHOLDER,
            'bodyClass' => $this->bodyClass
        );

        $renderer = SC_ViewRenderer::getInstance();
    ...
    {
        SC::getEventManager()->trigger(new SC_Event($name, $params));
    }
}
