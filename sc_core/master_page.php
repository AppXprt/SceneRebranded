 ...
 * @since 1.0
 */
class SC_MasterPage extends SC_Renderable
{
    /*
    ...
    protected function init()
    {
        ...
        $currentTheme = SC::getThemeManager()->getCurrentTheme()->getDto();
        $values = json_decode(SC::getConfig()->getValue('base', 'master_page_theme_info'), true);
    ...
    public function onBeforeRender()
    {
        ...
        {
            $this->setTemplate(SC::getThemeManager()->getMasterPageTemplate(self::TEMPLATE_GENERAL));
        }
