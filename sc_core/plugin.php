...
class SC_Plugin
{
    ...
    {
        return SC_DIR_PLUGIN_USERFILES . $this->getDirName() . DS;
    }
    ...
    {
        return SC_URL_PLUGIN_USERFILES . $this->getDirName() . "/";
    }

    public function getPluginFilesDir()
    {
        return SC_DIR_PLUGINFILES . $this->getDirName() . DS;
    }
    ...
    {
        return ($this->dto->isSystem() ? SC_DIR_SYSTEM_PLUGIN : SC_DIR_PLUGIN) . $this->getDirName() . DS;
    }
    ...
    {
        return SC_DIR_STATIC_PLUGIN . $this->getModuleName() . DS;
    }
    ...
    {
        return SC_URL_STATIC_PLUGINS . $this->getModuleName() . "/";
    }
