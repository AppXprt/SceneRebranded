...
/**
 * SC_Router is responsible for routing process, i.e. finding which controller and action should recieve request.
 * 
 * @author Sardar Madumarov <madumarov@gmail.com>
 * @package sc_core
 * @method static SC_Router getInstance()
 * @since 1.0
 */
class SC_Router
{
     ...
     * @return SC_Router
     */
    public function setDefaultRoute( SC_DefaultRoute $defaultRoute )
    {
     ...
     * @param SC_RouteAbstract $route
     * @return SC_Router
     */
    public function addRoute( SC_Route $route )
    {
