 ...
 * @since 1.0
 */
abstract class SC_Renderable extends SC_View
{
    /**
     ...
     *
     * @param string $key
     * @param SC_Renderable $component
     */
    public function addComponent( $key, SC_Renderable $component )
    {
    ...
    protected function onRender()
    {
        ...
        if ( !empty($this->forms) )
        {
            $viewRenderer->assignVar("_scForms_", $this->forms);
        }
    }
}
