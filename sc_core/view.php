...
class SC_View
{
    ...
    {
        return SC::getEventManager()->trigger(new SC_Event($name, $params, $data));
    }
     ...
     * @return mixed
     */
    protected function triggerEventForObject( SC_Event $event )
    {
        return SC::getEventManager()->trigger($event);
    }
}
