...
class Form
{
    ...
    public function __construct( $name )
    {
        ...
        $this->setEmptyElementsErrorMessage(SC::getLanguage()->text('base', 'form_validate_common_error_message'));
    ...
    public function isValid( $data )
    {
        ...
        )
        {
            ...
            SC::getFeedback()->error(SC::getLanguage()->text("base", "invalid_csrf_token_error_message"));
        }
    ...
    public function render( $formContent, array $params = array() )
    {
        ...
        $jsString = " var form = new ScForm(" . json_encode($formInitParams) . ");window.scForms[form.name] = form;
			...
			if ( form.form ) 
			{
    			...
    			$(form.form).bind( 'submit', {form:form},
                        ...
                        SC.trigger('base.onFormReady.' + form.name, [], form);
                        SC.trigger('base.onFormReady', [form]);
		";
        ...
        SC::getDocument()->addOnloadScript($jsString, 10);

        $hiddenFieldString = '';

        /* @var $value SC_FormElement */
