...
class Redirect404Exception extends InterceptException
{
    ...
    {
        $route = SC::getRouter()->getRoute('base_page_404');
...
class Redirect500Exception extends RedirectException
{
    ...
    public function __construct()
    {
        parent::__construct(SC_URL_HOME . '500.phtml', 500);
    }
}
...
class Redirect403Exception extends InterceptException
{
    ...
    public function __construct( $message = null )
    {
        $route = SC::getRouter()->getRoute('base_page_403');
...
class RedirectConfirmPageException extends RedirectException
{
    ...
    {
        parent::__construct(SC::getRequest()->buildUrlQueryString(SC::getRouter()->urlForRoute('base_page_confirm'), array('back_uri' => urlencode(SC::getRequest()->getRequestUri()))));
        SC::getSession()->set('baseConfirmPageMessage', $message);
    }
}
...
class RedirectAlertPageException extends RedirectException
{
    ...
    public function __construct( $message )
    {
        parent::__construct(SC::getRouter()->urlForRoute('base_page_alert'));
        SC::getSession()->set('baseAlertPageMessage', $message);
    }
}
...
class AuthenticateException extends RedirectException
{
    ...
    public function __construct()
    {
        parent::__construct(SC::getRequest()->buildUrlQueryString(SC::getRouter()->urlForRoute('static_sign_in'), array('back-uri' => urlencode(SC::getRequest()->getRequestUri()))));
    }
}
