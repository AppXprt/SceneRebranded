 ...
 * @since 1.0
 */
abstract class SC_ActionController extends SC_Renderable
{
    /**
    ...
    {
        $handlerAttrs = SC::getRequestHandler()->getHandlerAttributes();

        SC::getApplication()->redirect(SC::getRouter()->uriFor($handlerAttrs['controller'], trim($action)));
    }
    ...
    {
        SC::getApplication()->redirect($redirectTo);
    }
    ...
    {
        SC::getApplication()->setDocumentKey($key);
    }
    ...
    {
        return SC::getApplication()->getDocumentKey();
    }
    ...
    {
        SC::getDocument()->setHeading(trim($heading));
    }
    ...
    {
        SC::getDocument()->setHeadingIconClass($class);
    }
    ...
    {
        SC::getDocument()->setTitle(trim($title));
    }
    ...
    {
        SC::getDocument()->setDescription($desc);
    }
    ...
    {
        SC::getDocument()->setKeywords($keywords);
    }
}
