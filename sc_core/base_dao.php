...
abstract class SC_BaseDao
{
    ...
    public function findListByExample( SC_Example $example, $cacheLifeTime = 0, $tags = array() )
    {
        if ( $example === null )
        {
    ...
    public function countByExample( SC_Example $example, $cacheLifeTime = 0, $tags = array() )
    {
        if ( $example === null )
        {
            throw new InvalidArgumentException('argument must not be null');
    ...
    public function findObjectByExample( SC_Example $example, $cacheLifeTime = 0, $tags = array() )
    {
        if ( $example === null )
        {
            throw new InvalidArgumentException('argument must not be null');
    ...
    public function deleteByExample( SC_Example $example )
    {
     ...
     *
     * @param SC_Entity $entity
     * 
     * @throws InvalidArgumentException
     */
    public function save( $entity )
    {
        if ( $entity === null || !($entity instanceof SC_Entity) )
        {
            throw new InvalidArgumentException('Argument must be instance of SC_Entity and cannot be null');
        }
    ...
    public function findIdByExample( SC_Example $example, $cacheLifeTime = 0, $tags = array() )
    {
        if ( $example === null )
        {
            throw new InvalidArgumentException('argument must not be null');
    ...
    public function findIdListByExample( SC_Example $example, $cacheLifeTime = 0, $tags = array() )
    {
        if ( $example === null )
        {
            throw new InvalidArgumentException('argument must not be null');
    ...
    protected function clearCache()
    {
        ...
        if ( $tagsToClear )
        {
            SC::getCacheManager()->clean($tagsToClear);
        }
    }
