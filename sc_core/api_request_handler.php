 ...
 * @package sc_core
 * @method static SC_ApiRequestHandler getInstance()
 * @since 1.0
 */
class SC_ApiRequestHandler extends SC_RequestHandler
{
    use SC_Singleton;
    ...
    {
        return $controller != null & $controller instanceof SC_ApiActionController;
    }
}
