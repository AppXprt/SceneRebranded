 ...
 * @since 1.0
 */
class RequiredValidator extends SC_Validator
{
    /**
     * Constructor.
     *
    ...
    {
        $errorMessage = SC::getLanguage()->text('base', 'form_validator_required_error_message');
    ...
    /**
     * @see SC_Validator::getJsValidator()
     *
     * @return string
     */
    public function getJsValidator()
 ...
 * @since 1.0
 */
class WyswygRequiredValidator extends SC_Validator
{
    /**
     * Constructor.
     *
 ...
 * @since 1.0
 */
class StringValidator extends SC_Validator
{
    /**
     * String min length
     *
    ...
    public function __construct( $min = null, $max = null )
    {
        ...
        $errorMessage = SC::getLanguage()->text('base', 'form_validator_string_error_message');
 ...
 * @since 1.0
 */
class RegExpValidator extends SC_Validator
{
    /**
     * @var string
     */
    ...
    public function __construct( $pattern = null )
    {
        ...
        $errorMessage = SC::getLanguage()->text('base', 'form_validator_regexp_error_message');
...
class EmailValidator extends RegExpValidator
{
    ...
    public function __construct()
    {
        ...
        $errorMessage = SC::getLanguage()->text('base', 'form_validator_email_error_message');
...
class UrlValidator extends RegExpValidator
{
    ...
    public function __construct()
    {
        ...
        $errorMessage = SC::getLanguage()->text('base', 'form_validator_url_error_message');
 ...
 * @since 8.1
 */
class InArrayValidator extends SC_Validator
{
    /**
     * Predefined values
     *
    ...
    public function __construct( array $predefinedValues  = array() )
    {
        ...
        $this->errorMessage = SC::getLanguage()->text('base', 'form_validate_common_error_message');
    }
 ...
 * @since 1.0
 */
class IntValidator extends SC_Validator
{
    /**
     * @var int
     */
    ...
    public function __construct( $min = null, $max = null )
    {
        ...
        $errorMessage = SC::getLanguage()->text('base', 'form_validator_int_error_message');
...
/**
 * Scene: Open Source Community Software
 * @copyright Skalfa LLC Copyright (C) 2009. All rights reserved.
 * @license CPAL 1.0 License - http://www.scene.org/license
 */
 ...
 * @since 1.0
 */
class FloatValidator extends SC_Validator
{
    /**
     * @var float
     */
    ...
    public function __construct( $min = null, $max = null )
    {
        ...
        $errorMessage = SC::getLanguage()->text('base', 'form_validator_float_error_message');
 ...
 * @since 1.0
 */
class DateValidator extends SC_Validator
{
    /**
     * @var int
     */
    ...
    public function __construct( $minYear = null, $maxYear = null )
    {
        ...
        $errorMessage = SC::getLanguage()->text('base', 'form_validator_date_error_message');
 ...
 * @since 1.0
 */
class CaptchaValidator extends SC_Validator
{
    protected $jsObjectName = null;

    public function __construct()
    {
        $errorMessage = SC::getLanguage()->text('base', 'form_validator_captcha_error_message');
...
class RangeValidator extends SC_Validator
{
    /**
     * @var int
     */
    ...
    public function __construct()
    {
        $errorMessage = SC::getLanguage()->text('base', 'form_validator_range_error_message');
