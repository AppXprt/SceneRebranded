 ...
 * @since 1.0
 */
abstract class SC_ApiActionController
{
    /**
    ...
    {
        if ( defined("SC_PROFILER_ENABLE") && SC_PROFILER_ENABLE ) {
            $this->assign('queryLog', SC::getDbo()->getQueryLog());
            $this->assign('queryCount', SC::getDbo()->getQueryCount());
            $this->assign('queryExecutionTime', SC::getDbo()->getTotalQueryExecTime());
