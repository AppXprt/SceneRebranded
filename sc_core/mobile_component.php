...
/**
 * SC_Component is the base class for all components (represents blocks of rendered markup).
 *
 * @author Sardar Madumarov <madumarov@gmail.com>
 * @package sc_core
 * @since 1.0
 */
abstract class SC_MobileComponent extends SC_Component
{
    ...
    public function render()
    {
        if ( $this->getTemplate() === null )
        {
            ...
            if ( $plugin !== null )
            {
                $template = SC::getAutoloader()->classToFilename(get_class($this), false);
