...
class TextSearchManagerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        SC::getTextSearchManager()->deleteAllEntities();
    }
    ...
    public function testDeleteEntities()
    {
        ...
        {
            SC::getTextSearchManager()->
                    addEntity($entitiy['entity_type'], $entitiy['entity_id'], $entitiy['text'], time(), $entitiy['tags']);

            SC::getTextSearchManager()->deleteEntity($entitiy['entity_type'], $entitiy['entity_id']);
        }

        // do we have entities?
        $entities = SC::getTextSearchManager()->getAllEntities(0, 2);
    ...
    public function testDeactivateAllEntities()
    {
        ...
        SC::getTextSearchManager()->deactivateAllEntities('forum_post');

        // search (we should get an empty result)
        $searchEntities = SC::getTextSearchManager()->searchEntities('forum', 0, 100);
        $this->assertInternalType('array', $searchEntities);
        $this->assertEquals(0, count($searchEntities));
        $this->assertEquals(0, SC::getTextSearchManager()->searchEntitiesCount('forum'));
    }
    ...
    public function testActivateAllEntities()
    {
        ...
        SC::getTextSearchManager()->deactivateAllEntities();

        // activate all entities
        SC::getTextSearchManager()->activateAllEntities();

        // get all entities
        $entities = SC::getTextSearchManager()->getAllEntities(0, 3);
    ...
    public function testSearchEntities()
    {
        ...
        $this->assertEquals(1, SC::getTextSearchManager()->searchEntitiesCount('forum'));
        $entities = SC::getTextSearchManager()->searchEntities('forum', 0, 100);
        ...
        $this->assertEquals(0, SC::getTextSearchManager()->searchEntitiesCount('non existing entity'));
        $entities = SC::getTextSearchManager()->searchEntities('non existing entity', 0, 100);
        $this->assertInternalType('array', $entities);
        $this->assertEquals(0, count($entities));
    }
    ...
    public function testSearchEntitiesByTags()
    {
        ...
        $entities = SC::getTextSearchManager()->searchEntities('forum', 0, 100, array(
            'forum_post'
        ));
    ...
    public function testSetEntitiesStatusByTags()
    {
        ...
        foreach ($entities as $entitiy)
        {
            ...
            // inactivate entities
            SC::getTextSearchManager()->setEntitiesStatusByTags(array(
                'tag_1',
                'tag_2',
                'tag_3'
    ...
    public function testDeleteAllEntitiesByTags()
    {
        ...
        SC::getTextSearchManager()->deleteAllEntitiesByTags(array('tag_3', 'tag_2'));

        // we should find only a one entity
        $searchEntities = SC::getTextSearchManager()->searchEntities('forum post', 0, 100);
        $this->assertInternalType('array', $searchEntities);
