...
function smarty_modifier_more( $string, $length )
{
    ...
    $uniqId = uniqid("more-");
    $seeMoreEmbed = '<a href="javascript://" class="sc_small" onclick="$(\'#' . $uniqId . '\').attr(\'data-collapsed\', 0);" style="padding-left:4px;">'
            . SC::getLanguage()->text("base", "comments_see_more_label") 
            . '</a>';
    
    return '<span class="sc_more_text" data-collapsed="1" id="' . $uniqId . '">'
