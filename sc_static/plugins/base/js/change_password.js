var SC_ChangePassword = function($params)
{
        var self = this;
	...
	this.responderUrl = $params.responderUrl;
        ...
        {
            var element = scForms[this.formName].elements['oldPassword'];
           ...
           //var data = $.httpData( xhr, 'json');
            ...
            {
                 var text = SC.getLanguageText('base', 'join_error_password_not_valid');
...
//                             element.showError( SC.getLanguageText('base', 'join_error_password_not_valid') );
//                        }
//                    }
//            } );
