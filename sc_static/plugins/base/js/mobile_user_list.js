var SC_UserList = function( params )
{
    params = params || {};
...
SC_UserList.prototype =
{
    ...
    {
        var self = this;
        SCM.loadComponent( self.cmp, [self.list, data, self.showOnline], function( content ) {  self.append(content); self.setProsessStatus(false);  } );
