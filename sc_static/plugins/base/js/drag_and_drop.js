SC_Components_DragAndDrop = function() {
    ...
    $('#reset_position_btn').click(function(){
    	if ( confirm( SC.getLanguageText('base', 'widgets_reset_position_confirm') ) ) {
...
SC_Components_DragAndDrop.prototype = new componentDragAndDrop ({
	...
	clone: function(sortable, $cloningItem) {
        ...
        var $destItem = $('<div class="sc_dnd_preloader sc_preloader_content sc_stdmargin"></div>');
    ...
    handleStop: function(sortable, e, ui) {
    	...
    	var $preloader = $('<div class="sc_dnd_preloader sc_preloader_content sc_stdmargin"></div>');
