...
AvatarUserSelect.prototype = {
                ...
                $('#'+data.linkId).click(
                    function(){
                        ...
                        if( uai == null ){
                            ...
                            $(this).addClass('sc_mild_green');
                        }else{
                             self.resultList.splice(uai, 1);
                            $(this).removeClass('sc_mild_green');
                        }
    ...
    submit: function(){
        ...
        {
            SC.warning(SC.getLanguageText('base', 'avatar_user_select_empty_list_message'));
            return;
        }
        SC.trigger('base.avatar_user_list_select', [this.resultList]);
    }
}