        ...
        custom: {
            ...
            image: function(textarea, suitUpBlock) 
            {
                ...
                var $uploadImage = $('<input type="file" class="suitup_upload_image" style="display:none" accept="image/*" />' ).html5_upload({
                    ...
                    onFinishOne: function(event, response, name, number, total) 
                    {
                        ...
                        {
                           SCM.message(result.error_message, 'error');
                           return;
                        }
            ...
            link: function(textarea, suitUpBlock) 
            {
                return create("a", {
                    ...
                    if (!$.suitUp.hasSelectedNodeParent("a")) {
                        ...
                        var floatBox = SCM.ajaxFloatBox("BASE_MCMP_InsertLink", [{ "linkText" : $.suitUp.getSelectedText() }], {
                            "title" : SC.getLanguageText('base', 'ws_button_label_link'),
                            "scope" : {
            ...
            video: function(textarea, suitUpBlock) 
            {
                return create("a", {
                    ...
                    var floatBox = SCM.ajaxFloatBox("BASE_MCMP_InsertVideo", [], {
                         "title" : SC.getLanguageText('base', 'ws_button_label_video'),
                         "scope" : {
                            "success" : function(data) {
                                $.ajax({
                                    url: $.suitUp.embedUrl,
                                    ...
                                    success: function(response) {
                                        ...
                                        if (typeof data.type == "undefined" 
                                            ...
                                            SCM.message(SC.getLanguageText('base', 'ws_error_video'), 'error');
                                            return;
                                        }
