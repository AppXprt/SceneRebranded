SC_Components_DragAndDropAjaxHandler = function(urlResponder, sharedData) {
	this.ajax = new SC_Component_Ajax(urlResponder);
	this.sharedData = sharedData;
};

SC_Components_DragAndDropAjaxHandler.prototype = {
