var SC_Captcha = function( $params )
{
    var self = this;
    ...
    {
            var element = scForms[self.form.attr('name')].elements[this.captcha.attr('name')];
           ...
           //var data = $.httpData( xhr, 'json' );
            ...
            {
                 // self.errors['captcha']['error'] = SC.getLanguageText('base', 'join_error_password_not_valid');
                 self.refresh();
                 return false;
            }
