   ...
   // System functions
    ...
    Panel = function( panelKey, delegate ) {
        ...
        this.options = {
            ...
            placeholder: 'sc_dnd_placeholder',
            clone: "original",
    ...
    $.extend(DefaultDelegate.prototype, {
        ...
        actionClick: function( panel, item, action ) {
            ...
            if ( action === "edit" ) {
                editFloatBox = SC.ajaxFloatBox("ADMIN_CMP_MobileNavigationItemSettings", [item.data("key")], {
                    "title": SC.getLanguageText("mobile", "admin_nav_settings_fb_title"),
                    "scope": {
    ...
    $.extend(NewDelegate.prototype, DefaultDelegate.prototype, {
        createItem: function( from ) {
            ...
            return changeItem(item, {
                ...
                "title": SC.getLanguageText("mobile", "admin_nav_adding_message"),
                "locked": true,
