...
class ADMIN_CLASS_SeoMetaForm extends Form
{
    ...
    public function processData( $post )
    {
        ...
        if( $this->isValid($post) ){
            ...
            SC_DeveloperTools::getInstance()->clearLanguagesCache();
...
class MetaInfoValidator extends SC_Validator
{
    /**
     * Class constructor
     *
    ...
    {
        $this->setErrorMessage(SC::getLanguage()->text("base", "invalid_meta_error_message"));
    }
