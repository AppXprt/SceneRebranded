 ...
 * @since 1.0
 */
abstract class ADMIN_CTRL_Abstract extends SC_ActionController
{
    ...
    public function __construct()
    {
        ...
        if ( SC::getApplication()->getContext() != SC_Application::CONTEXT_DESKTOP )
        {
            throw new InterceptException(array(SC_RequestHandler::ATTRS_KEY_CTRL => 'BASE_MCTRL_BaseDocument', SC_RequestHandler::ATTRS_KEY_ACTION => 'notAvailable'));
        }
        ...
        if ( !SC::getRequest()->isAjax() )
        {
            ...
            $this->setPageTitle(SC::getLanguage()->text('admin', 'page_default_title'));
        }
    }

    public function setPageTitle( $title )
    {
        SC::getDocument()->setTitle($title);
    }
}
