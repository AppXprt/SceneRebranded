...
class ADMIN_CTRL_PagesEditLocal extends ADMIN_CTRL_Abstract
{
    ...
    public function __construct()
    {
        ...
        $this->assign('homeUrl', SC::getRouter()->getBaseUrl());
    }
...
//--
            ...
            $uri = str_replace(UTIL_String::removeFirstAndLastSlashes(SC::getRouter()->getBaseUrl()), '', UTIL_String::removeFirstAndLastSlashes($data['url']));
...
//--
    ...
    public function delete( $params )
    {
        ...
        $this->redirect(SC::getRouter()->urlForRoute('admin_pages_main'));
    }
}
...
class EditLocalPageForm extends Form
{
    ...
    public function __construct( $name, BOL_MenuItem $menu )
    {
        ...
        $this->addElement(
                ...
                ->setLabel(SC::getLanguage()->text('admin', 'pages_edit_local_page_title'))
                ->setRequired(true)
        );
        ...
        $this->addElement(
                ...
                ->setLabel(SC::getLanguage()->text('admin', 'pages_edit_local_page_url'))
                ->setRequired(true)
        );
        ...
        $this->addElement(
            $metaTagsTextarea->setLabel(SC::getLanguage()->text("base", "pages_page_meta_keywords_label"))
                ->setValue($langValue)
                ->setDescription(SC::getLanguage()->text('base', 'pages_page_meta_keywords_desc'))
        );
        ...
        $this->addElement(
            $metaTagsTextarea->setLabel(SC::getLanguage()->text("base", "pages_page_meta_desc_label"))
                ->setValue($langValue)
                ->setDescription(SC::getLanguage()->text('base', 'pages_page_meta_desc_desc'))
        );
        ...
        $this->addElement(
                $contentTextArea->setLabel(SC::getLanguage()->text('admin', 'pages_edit_local_page_content'))
                ->setValue($langValue)
                ->setId('content')
        );
