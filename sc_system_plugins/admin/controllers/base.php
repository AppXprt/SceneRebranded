...
class ADMIN_CTRL_Base extends ADMIN_CTRL_Abstract
{
    ...
    {
        $this->setPageHeading(SC::getLanguage()->text('admin', 'admin_dashboard'));
    ...
    public function generateSitemap()
    {
        ...
        while ( !(int) SC::getConfig()->getValue('base', 'seo_sitemap_build_finished') );
    ...
    public function dashboard( $paramList )
    {
        ...
        $customizeUrls = array(
            'customize' => SC::getRouter()->urlForRoute('admin_dashboard_customize', array('mode' => 'customize')),
            'normal' => SC::getRouter()->urlForRoute('admin_dashboard')
        );
