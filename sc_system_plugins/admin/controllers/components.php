...
class ADMIN_CTRL_Components extends ADMIN_CTRL_Abstract
{
    ...
    {
        $basePluginDir = SC::getPluginManager()->getPlugin('BASE')->getRootDir();

        $controllersTemplate = SC::getPluginManager()->getPlugin('ADMIN')->getCtrlViewDir() . 'drag_and_drop_components.html';
    ...
    {
        $this->setPageHeading(SC::getLanguage()->text('base', 'widgets_admin_dashboard_heading'));
    ...
    {
        $this->setPageHeading(SC::getLanguage()->text('base', 'widgets_admin_profile_heading'));
