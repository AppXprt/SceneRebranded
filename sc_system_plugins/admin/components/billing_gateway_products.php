...
/**
 * Billing gateway products setup component
 * 
 * @author Egor Bulgakov <egor.bulgakov@gmail.com>
 * @package sc_system_plugins.base.components
 * @since 1.2.7
 */
class ADMIN_CMP_BillingGatewayProducts extends SC_Component
{
    public function __construct( $params = array() )
    {
        ...
        $this->assign('actionUrl', SC::getRouter()->urlFor('BASE_CTRL_Billing', 'saveGatewayProduct'));
        $this->assign('backUrl', urlencode(SC::getRouter()->getBaseUrl() . SC::getRouter()->getUri()));
    }
}