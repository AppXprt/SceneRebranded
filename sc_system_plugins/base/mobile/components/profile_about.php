...
class BASE_MCMP_ProfileAbout extends SC_MobileComponent
{
    /**
     *
     * @var BOL_User
    ...
    public function onBeforeRender()
    {
        ...
        $this->assign('aboutUrl', SC::getRouter()->urlForRoute('base_about_profile', array('username' => $this->user->username)));
