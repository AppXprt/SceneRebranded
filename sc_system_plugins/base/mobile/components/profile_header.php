...
class BASE_MCMP_ProfileHeader extends SC_MobileComponent
{
    /**
     *
     * @var BOL_User
    ...
    public function onBeforeRender() 
    {
        ...
        if ( SC::getUser()->getId() == $this->user->getId() )
        {
            $owner = true;
        }
        ...
        $this->addComponent('toolbar', SC::getClassInstance("BASE_MCMP_ProfileActionToolbar", $this->user->id));
        ...
        $permissions = SC::getEventManager()->getInstance()->call('privacy_check_permission_for_user_list', $eventParams);
