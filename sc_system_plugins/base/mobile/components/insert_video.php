 ...
 * @since 1.0
 */
class BASE_MCMP_InsertVideo extends SC_MobileComponent
{
    /**
     * Class constructor
     * 
...
class InsertVideoForm extends Form
{
    public function __construct()
    {
        ...
        $linkField->setRequired(true)->setHasInvitation(true)->setInvitation(SC::getLanguage()->text('base', 'ws_video_text_label'));
