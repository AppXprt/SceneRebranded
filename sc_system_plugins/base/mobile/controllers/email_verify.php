 ...
 * @package sc_system_plugins.base.mobile.controller
 * @since 1.0
 */
class BASE_MCTRL_EmailVerify extends BASE_CTRL_EmailVerify
{
    ...
    public function index( $params )
    {
        ...
        $this->setTemplate(SC::getPluginManager()->getPlugin('base')->getMobileCtrlViewDir().'email_verify_index.html');
    }
    ...
    public function verify( $params )
    {
        ...
        $this->setTemplate(SC::getPluginManager()->getPlugin('base')->getMobileCtrlViewDir().'email_verify_verify.html');
    }
    ...
    public function verifyForm( $params )
    {
        ...
        SC::getDocument()->getMasterPage()->setTemplate(SC::getThemeManager()->getMasterPageTemplate(SC_MobileMasterPage::TEMPLATE_BLANK));
        $this->setTemplate(SC::getPluginManager()->getPlugin('base')->getMobileCtrlViewDir().'email_verify_verify_form.html');
    }
}
