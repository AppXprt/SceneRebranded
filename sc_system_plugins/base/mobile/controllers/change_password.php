 ...
 * @since 1.8.6
 */
class BASE_MCTRL_ChangePassword extends SC_MobileActionController
{
    /**
     * Index
     */
    ...
    {
        $this->setPageTitle(SC::getLanguage()->text('mobile', 'change_password_page'));
        $this->setPageHeading(SC::getLanguage()->text('mobile', 'change_password_page'));
