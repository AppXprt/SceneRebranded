 ...
 * @since 1.0
 */
class BASE_MCTRL_UserList extends SC_MobileActionController
{
    ...
    public function __construct()
    {
        ...
        $this->setPageTitle(SC::getLanguage()->text('base', 'users_browse_page_heading'));
    ...
    public function index( $params )
    {
        ...
        SC::getDocument()->addScript(SC::getPluginManager()->getPlugin('base')->getStaticJsUrl().'mobile_user_list.js');
        ...
        SC::getDocument()->addOnloadScript(" 
            window.mobileUserList = new SC_UserList(".  json_encode(array(
                    ...
                    'responderUrl' => SC::getRouter()->urlForRoute('base_user_lists_responder')
                )).");
        ", 50);
    }
