 ...
 * @since 1.0
 */
class BASE_CMP_TagCloud extends SC_Component
{
    /**
     * @var string
     */
    ...
    public function onBeforeRender()
    {
        ...
        foreach ( $list as $key => $value )
        {
            ...
            $tags[$key]['url'] = ($this->routeName === null) ? SC::getRequest()->buildUrlQueryString($this->url, array('tag' => $value['label'])) : SC::getRouter()->urlForRoute($this->routeName, array('tag' => $value['label']));
