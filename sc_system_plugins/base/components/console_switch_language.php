...
public function __construct()
    {
        ...
        $template = SC::getPluginManager()->getPlugin('BASE')->getCmpViewDir() . 'console_switch_language.html';
        ...
        foreach($languages as $id=>$language)
        {
            if ( $language->status == 'active' )
            {
                ...
                $active_lang = array(
                    ...
                    'tag'=>$language->tag,
                    'class'=>"sc_console_lang{$tag['country']}",
                    'url'=> SC::getRequest()->buildUrlQueryString(null, array( "language_id"=>$language->id ) ),
                    'is_current'=>false
                    );
                ...
                if ( $session_language_id == $language->id )
                {
                        ...
                        $this->assign('class', "sc_console_lang{$tag['country']}");
                }
