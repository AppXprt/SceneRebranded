 ...
 * @since 1.0
 */
class BASE_CMP_ExtendedTagCloud extends SC_Component
{
    /**
     * @var integer
     */
    ...
    /**
     * @see SC_Rendarable::onBeforeRender
     */
    public function onBeforeRender()
    {
        ...
        {
            $tags[$key]['url'] = ($this->routeName === null) ? SC::getRequest()->buildUrlQueryString($this->url, array('tag' => $value['tagLabel'])) : SC::getRouter()->urlForRoute($this->routeName, array('tag' => $value['tagLabel']));
