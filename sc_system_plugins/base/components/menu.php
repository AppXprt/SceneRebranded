 ...
 * @since 1.0
 */
class BASE_CMP_Menu extends SC_Component
{
    /**
     * @var array
     */
    ...
    public function __construct( $menuItems = array() )
    {
        ...
        $this->setTemplate(SC::getPluginManager()->getPlugin('base')->getCmpViewDir() . 'menu.html');
    }
    ...
    public function onBeforeRender()
    {
        ...
        {
            $menuItem->activate(SC::getRouter()->getBaseUrl() . SC::getRequest()->getRequestUri());
            $arrayToAssign[] = $this->getItemViewData($menuItem);
        }

        $this->assign('class', 'sc_' . SC_Autoload::getInstance()->classToFilename(get_class($this), false));
