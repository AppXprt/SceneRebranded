...
/**
 *
 * @author Podiachev Evgeny <joker.SC2@gmail.com>
 * @package sc_system_plugins.base.components
 * @since 1.7.2
 */

class BASE_CMP_SetSuspendMessage extends SC_Component
{
    /**
     * @return Constructor.
     */
    public function __construct()
    {
        ...
        $submit->setLabel(SC::getLanguage()->text('base', 'submit'));
...
//                ');
    ...
    {
        SC::getLanguage()->addKeyForJs('base', 'set_suspend_message_label ');
        
        $form->bindJsFunction(Form::BIND_SUBMIT, ' function(e) { 
                
                SC.trigger("base.on_suspend_command", [\'suspend\', e.message]);
