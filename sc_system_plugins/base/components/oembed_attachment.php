 ...
 * @since 1.0
 */
class BASE_CMP_OembedAttachment extends SC_Component
{
    ...
    public function initJs()
    {
        ...
        $js->addScript('$(".sc_oembed_video_cover", "#" + {$uniqId}).click(function() { '
                . '$(".two_column", "#" + {$uniqId}).addClass("sc_video_playing"); '
                . '$(".attachment_left", "#" + {$uniqId}).html({$embed});'
                . 'SC.trigger("base.comment_video_play", {});'
                . 'return false; });', array(
            "uniqId" => $this->uniqId,
            "embed" => $code
        ));
