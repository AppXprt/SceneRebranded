...
class BASE_CMP_ConsoleDropdownList extends BASE_CMP_ConsoleDropdownClick
{
    ...
    public function __construct($label, $key)
    {
        ...
        $template = SC::getPluginManager()->getPlugin('BASE')->getCmpViewDir() . 'console_dropdown_list.html';
    ...
    protected function initJs()
    {
        ...
        $js->addScript('SC.Console.addItem(new SC_ConsoleDropdownList({$uniqId}, {$contentIniqId}), {$key});', array(
