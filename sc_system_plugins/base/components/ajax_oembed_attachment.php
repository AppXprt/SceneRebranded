 ...
 * @since 1.0
 */
class BASE_CMP_AjaxOembedAttachment extends SC_Component
{
    ...
    public function initJs()
    {
        ...
        $js->newObject(array('SC_AttachmentItemColletction', $this->uniqId), 'SC_Attachment', array($this->uniqId, $this->oembed));
