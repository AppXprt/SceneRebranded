...
class BASE_CMP_ContentPresenter extends SC_Component
{
...
class BASE_ContentPresenter extends SC_Component
{
    ...
    public function __construct( $content, $displayFormat ) 
    {
        ...
        $this->setTemplate(SC::getPluginManager()->getPlugin("base")
    ...
    public function onBeforeRender() 
    {
        ...
        $event = new SC_Event("content.before_presenter_render", array(
    ...
    protected function prepare() 
    {
        ...
        if ( $this->content['html'] )
        {
            ...
            $js->addScript('$("[data-action=play]", "#" + {$uniqId}).click(function(e) { '
                    ...
                    . '$(".sc_newsfeed_oembed_atch", "#" + {$uniqId}).addClass("sc_video_playing"); '
                    . '$(".sc_newsfeed_item_picture", "#" + {$uniqId}).html({$embed});'
                    . 'return false; });', array(
                "uniqId" => $this->uniqId,
                "embed" => $code
            ));
