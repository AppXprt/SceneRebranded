 ...
 * @since 1.0
 */
class BASE_CMP_AvatarUserList extends SC_Component
{
    const CSS_CLASS_MINI_AVATAR = 'sc_mini_avatar';
    ...
    public function onBeforeRender()
    {
        ...
        $event = new SC_Event('bookmarks.is_mark', array(), $avatars);
        ...
        {
            $this->assign('view_more_array', array('url' => $this->viewMoreUrl, 'title' => SC::getLanguage()->text('base', 'view_more_label')));
        }
