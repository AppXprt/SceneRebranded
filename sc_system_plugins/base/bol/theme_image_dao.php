 ...
 * @since 1.0
 */
class BOL_ThemeImageDao extends SC_BaseDao
{
    ...
    {
        return SC_DB_PREFIX . 'base_theme_image';
    }
    ...
    /**
     * @param SC_Example$example
     * @param array $params
     */
    private function applyDatesBetweenFilter(SC_Example $example, $params)
    {
     ...
     * @param array $params
     */
    private function applyLimitClause(SC_Example $example, $params)
    {
