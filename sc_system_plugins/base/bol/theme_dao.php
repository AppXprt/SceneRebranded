 ...
 * @since 1.0
 */
class BOL_ThemeDao extends SC_BaseDao
{
    const ID = 'id';
    const KEY = 'key';
    const TITLE = 'title';
    ...
    {
        return SC_DB_PREFIX . 'base_theme';
    }
    ...
    public function findByKey( $name )
    {
        ...
        return $this->findObjectByExample($example, 24 * 3600, array(self::CACHE_TAG_PAGE_LOAD_THEME, SC_CacheManager::TAG_OPTION_INSTANT_LOAD));
    }
