...
class BOL_MobileNavigationService
{
    ...
    public function createEmptyItem( $menu, $order )
    {
        ...
        $this->editItem($menuItem, array(
            self::SETTING_LABEL => SC::getLanguage()->text("mobile", "admin_nav_default_menu_name"),
            self::SETTING_TITLE => SC::getLanguage()->text("mobile", "admin_nav_default_page_title"),
            self::SETTING_CONTENT => SC::getLanguage()->text("mobile", "admin_nav_default_page_content"),
