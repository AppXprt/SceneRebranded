...
class BOL_MailService
{
    ...
    private function __construct()
    {
        ...
        $siteName = SC::getConfig()->getValue('base', 'site_name');
        $siteEmail = SC::getConfig()->getValue('base', 'site_email');
        $senderSuffix = defined('SC_SENDER_MAIL_SUFFIX') ? SC_SENDER_MAIL_SUFFIX : null;
    ...
    {
        if ( SC::getConfig()->getValue('base', 'mail_smtp_enabled') )
        {
    ...
    public function send( BASE_CLASS_Mail $mail )
    {
        ...
        $event = new SC_Event('base.mail_service.send.check_mail_state', array(), $mailState);
