 ...
 * @since 1.0
 */
class BOL_AuthorizationModeratorPermissionDao extends SC_BaseDao
{
    ...
    {
        return SC_DB_PREFIX . 'base_authorization_moderator_permission';
    }
    ...
    {
        SC::getCacheManager()->clean(array(BOL_AuthorizationActionDao::CACHE_TAG_AUTHORIZATION));
    }

    public function findAll( $cacheLifeTime = 0, $tags = array() )
    {
        return parent::findAll(3600 * 24, array(BOL_AuthorizationActionDao::CACHE_TAG_AUTHORIZATION, SC_CacheManager::TAG_OPTION_INSTANT_LOAD));
    }
}