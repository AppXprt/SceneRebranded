 ...
 * @since 1.0
 */
require( SC_DIR_LIB . 'rackspace_cloudfiles' . DS . 'cloudfiles.php');

class BASE_CLASS_CloudStorage implements SC_Storage
{
    ...
    public function __construct()
    {
        ...
        $this->auth = new CF_Authentication(SC_CLOUDFILES_USER, SC_CLOUDFILES_API_KEY);
        $this->auth->authenticate();
        $this->connection = new CF_Connection($this->auth);
        $this->container = $this->connection->get_container(SC_CLOUDFILES_CONTAINER);
    }
