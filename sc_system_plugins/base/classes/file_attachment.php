 ...
 * @since 1.0
 */
class BASE_CLASS_FileAttachment extends SC_Component
{
    private $uid;
    ...
    public function onBeforeRender()
    {
        ...
        $params = array(
            'uid' => $this->uid,
            'submitUrl' => SC::getRouter()->urlFor('BASE_CTRL_Attachment', 'addFile'),
            'deleteUrl' => SC::getRouter()->urlFor('BASE_CTRL_Attachment', 'deleteFile'),
        ...
        SC::getDocument()->addOnloadScript("owFileAttachments['" . $this->uid . "'] = new SCFileAttachment(" . json_encode($params) . ");");
