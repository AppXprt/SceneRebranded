 ...
 * @since 1.0
 */
class BASE_CLASS_CacheBackendMysql implements SC_ICacheBackend
{
    /**
     * @var array
     */
    ...
    public function __construct( SC_Database $dbo )
    {
        $this->dbo = $dbo;
    ...
    public function clean( array $tags, $mode )
    {
        ...
        switch ( $mode )
        {
            ...
            case SC_CacheManager::CLEAN_OLD:
    ...
    public function save( $data, $key, array $tags = array(), $lifeTime )
    {
        ...
        $optionIndex = array_search(SC_CacheManager::TAG_OPTION_INSTANT_LOAD, $tags);
    ...
    {
        return SC_DB_PREFIX . 'base_cache';
    }

    private function getTagsTableName()
    {
        return SC_DB_PREFIX . 'base_cache_tag';
    }
}