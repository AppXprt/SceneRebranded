 ...
 * @package sc_system_plugins.base.class
 * @since 1.0
 */
class BASE_CLASS_FileLogWriter extends SC_LogWriter
{
    /**
     * @var string
     */
    ...
    public function processEntries( array $entries )
    {
        ...
        {
            $date = date("D M j G:i:s Y", $entry[SC_Log::TIME_STAMP]);
            $stringToWrite .= "[$date] [{$entry[SC_Log::TYPE]}] [{$entry[SC_Log::KEY]}] {$entry[SC_Log::MESSAGE]}" . PHP_EOL;
        }
