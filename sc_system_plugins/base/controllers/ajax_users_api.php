 ...
 * @since 1.0
 */
class BASE_CTRL_AjaxUsersApi extends SC_ActionController
{
    ...
    private function suspend( $params )
    {
        ...
        return array(
            "info" => SC::getLanguage()->text('base', 'user_feedback_profile_suspended')
        );
    }
    ...
    private function deleteUser( $params )
    {
        ...
        return array(
            "info" => SC::getLanguage()->text('base', 'user_deleted_page_message')
        );
    }
    ...
    private function unsuspend( $params )
    {
        ...
        return array(
            "info" => SC::getLanguage()->text('base', 'user_feedback_profile_unsuspended')
        );
    }
    ...
    private function block( $params )
    {
        ...
        return array(
            "info" => SC::getLanguage()->text('base', 'user_feedback_profile_blocked')
        );
    }
    ...
    private function unblock( $params )
    {
        ...
        return array(
            "info" => SC::getLanguage()->text('base', 'user_feedback_profile_unblocked')
        );
    }
    ...
    private function feature( $params )
    {
        ...
        return array(
            "info" => SC::getLanguage()->text('base', 'user_feedback_marked_as_featured')
        );
    }
    ...
    private function unfeature( $params )
    {
        ...
        return array(
            "info" => SC::getLanguage()->text('base', 'user_feedback_unmarked_as_featured')
        );
    }
