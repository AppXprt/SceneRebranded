 ...
 * @since 1.0
 */
class BASE_CTRL_AjaxLoader extends SC_ActionController
{
    ...
    public function component()
    {
        ...
        $cmp = SC::getClassInstanceArray($cmpClass, $params);
        $responce = $this->getComponentMarkup($cmp);

        exit(json_encode($responce));
    }

    protected function getComponentMarkup( SC_Component $cmp )
    {
