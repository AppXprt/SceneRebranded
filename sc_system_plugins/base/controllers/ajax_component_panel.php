 ...
 * @since 1.0
 */
abstract class BASE_CTRL_AjaxComponentPanel extends SC_ActionController
{
    private $actions = array();
    private $debug = array();

    /**
     * @see SC_ActionController::init()
     *
     */
    ...
    protected function getSettingFormMarkup( SC_Component $viewInstance )
    {
        /* @var $document SC_AjaxDocument */
        $document = SC::getDocument();
