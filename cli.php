...
define('SC_USE_CONTEXT', 8); // CLI context
define('DS', DIRECTORY_SEPARATOR);
define('SC_DIR_ROOT', __DIR__ . DS);

require_once SC_DIR_ROOT . 'sc_includes' . DS . 'init.php';
require_once SC_DIR_SYSTEM_PLUGIN . 'base' . DS . 'classes' . DS . 'cli_err_output.php';

SC_ErrorManager::getInstance()->setErrorOutput(new BASE_CLASS_CliErrOutput());
...
/* @var SC_CliApplication $application */
...
$event = new SC_Event(SC_EventManager::ON_CLI_RUN);
SC::getEventManager()->trigger($event);
