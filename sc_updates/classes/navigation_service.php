...
{
    const MAIN = SC_Navigation::MAIN;
    const BOTTOM = SC_Navigation::BOTTOM;

    const VISIBLE_FOR_GUEST = SC_Navigation::VISIBLE_FOR_GUEST;
    const VISIBLE_FOR_MEMBER = SC_Navigation::VISIBLE_FOR_MEMBER;
    const VISIBLE_FOR_ALL = SC_Navigation::VISIBLE_FOR_ALL;
    ...
    {
        $this->navigation = SC_Navigation::getInstance();
    }
