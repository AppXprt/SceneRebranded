...
$navigation = SC::getNavigation();

try
{
    $navigation->addMenuItem(
        SC_Navigation::ADMIN_MOBILE,
        'mobile.admin.navigation',
        'mobile',
        'mobile_admin_navigation',
        SC_Navigation::VISIBLE_FOR_ALL);
}
catch ( Exception $e )
{
    $logger->addEntry(json_encode($e));
...
{
    $navigation->addMenuItem(
        SC_Navigation::MOBILE_HIDDEN,
        'base_member_dashboard',
        'mobile',
        'mobile_pages_dashboard',
        SC_Navigation::VISIBLE_FOR_MEMBER);
}
catch ( Exception $e )
{
    $logger->addEntry(json_encode($e));
...
$wurflDir = SC_DIR_LIB . 'wurfl' . DS;
$resourcesDir = SC_DIR_PLUGINFILES . 'base' . DS . 'wurfl' . DS;
