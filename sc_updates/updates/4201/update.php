...
@mkdir(SC_DIR_PLUGIN_USERFILES.'base'.DS.'attachments');
@chmod(SC_DIR_PLUGIN_USERFILES.'base'.DS.'attachments', 0777);
@mkdir(SC_DIR_PLUGIN_USERFILES.'base'.DS.'attachments'.DS.'temp');
@chmod(SC_DIR_PLUGIN_USERFILES.'base'.DS.'attachments'.DS.'temp', 0777);
