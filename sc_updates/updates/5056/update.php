...
if ( defined('SC_USE_AMAZON_S3_CLOUDFILES') && SC_USE_AMAZON_S3_CLOUDFILES || defined('SC_USE_CLOUDFILES') && SC_USE_CLOUDFILES )
{
    ...
    {
		if ( file_exists(SC_DIR_THEME_USERFILES . $theme->getCustomCssFileName()) && is_file(SC_DIR_THEME_USERFILES . $theme->getCustomCssFileName()) )
		{
        	$storage->copyFile(SC_DIR_THEME_USERFILES . $theme->getCustomCssFileName(), SC_DIR_THEME_USERFILES . $theme->getCustomCssFileName());
		}
    }
}
