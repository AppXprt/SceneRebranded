...
$queryList = array(
    ...
    "ALTER TABLE `" . SC_DB_PREFIX . "base_billing_gateway` ADD `dynamic` TINYINT( 1 ) NULL DEFAULT '1' AFTER `recurring`;",
    "ALTER TABLE `" . SC_DB_PREFIX . "base_billing_gateway_product` ADD `pluginKey` VARCHAR( 255 ) NOT NULL AFTER `gatewayId`;",
    "ALTER TABLE `" . SC_DB_PREFIX . "base_billing_gateway_product` CHANGE `productId` `productId` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL;",
    "CREATE TABLE IF NOT EXISTS `" . SC_DB_PREFIX . "base_user_block` (
    ...
    "ALTER TABLE  `" . SC_DB_PREFIX . "base_search_result` ENGINE = MYISAM",
	"ALTER TABLE  `" . SC_DB_PREFIX . "base_preference_section` ENGINE = MYISAM",
	"ALTER TABLE  `" . SC_DB_PREFIX . "base_preference_data` ENGINE = MYISAM",
	"ALTER TABLE  `" . SC_DB_PREFIX . "base_log` ENGINE = MYISAM",
	"ALTER TABLE  `" . SC_DB_PREFIX . "base_search` ENGINE = MYISAM",
    // SARDAR REMOVE QUERY BELSC FOR SERVICE UPDATES
...
UPDATE_ConfigService::getInstance()->saveConfig('base', 'favicon', file_exists(SC_DIR_USERFILES . 'plugins' . DS . 'base' . DS . 'favicon.ico'));
...
foreach ( $themes as $theme )
{
    ...
    $filePath = SC_DIR_USERFILES . 'themes' . DS . $theme['customCssFileName'];
