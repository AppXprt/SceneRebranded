...
@mkdir(SC_DIR_PLUGIN_USERFILES . 'base' . DS . 'avatars' . DS . 'tmp');
@chmod(SC_DIR_PLUGIN_USERFILES . 'base' . DS . 'avatars' . DS . 'tmp', 0777);
...
try
{
    if ( !SC::getConfig()->configExists('base', 'avatar_max_upload_size') )
    {
        SC::getConfig()->addConfig('base', 'avatar_max_upload_size', true, 'Enable file attachments');
    }
}
catch ( Exception $e )
{
