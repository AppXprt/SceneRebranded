...
if ( $langId !== null )
{
    ...
    $value = 'It appears that following plugins/themes obtained through Scene Store and installed on your website ({$siteURL}) '
        ...
        . 'your Scene Store account: http://www.scene.org/store/granted-list/plugin <br /><br /> You may also contact '
        ...
        . 'plugins/themes sold through Scene Store are covered by Scene Store Commercial License (http://www.scene.org/store/oscl), '
    ...
    $value = 'It appears that following plugins/themes obtained through Scene Store and installed on your website ({$siteURL}) '
        ...
        . '{$adminUrl} You may find all licenses for purchased plugins/themes in your Scene Store account: http://www.scene.org/store/granted-list/plugin '
        ...
        . 'through Scene Store are covered by Scene Store Commercial License (http://www.scene.org/store/oscl), and require a valid license key to operate.';
