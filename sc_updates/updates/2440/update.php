...
$dirArray = array(
    SC_DIR_PLUGINFILES . 'admin' . DS . 'languages' . DS,
    SC_DIR_PLUGINFILES . 'admin' . DS . 'languages' . DS . 'export' . DS,
    SC_DIR_PLUGINFILES . 'admin' . DS . 'languages' . DS . 'import' . DS,
    SC_DIR_PLUGINFILES . 'admin' . DS . 'languages' . DS . 'tmp' . DS,
    SC_DIR_PLUGINFILES . 'ow' . DS,
    SC_DIR_PLUGINFILES . 'plugin' . DS
);
