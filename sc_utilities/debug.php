...
final class UTIL_Debug
{
    ...
    public static function varDump( $var, $exit = false )
    {
        ...
        $debugString = '
    	<div class="sc_debug_cont">
    		<div class="sc_debug_body">
    			<div class="sc_debug_cap vardump">SC Debug - Vardump</div>
    			<div>
    ...
    public static function printDebugMessage( $data )
    {
        ...
        $debugString = '
    		<div class="sc_debug_cont">
    			<div class="sc_debug_body">
    				<div class="sc_debug_cap ' . strtolower($data['type']) . '">SC Debug - ' . $data['type'] . '</div>
    				<table>
    					<tr>
    ...
    private static function addDebugStyles()
    {
        echo '
    	<style>
    		.sc_debug_cont{padding:15px 0;width:80%;margin:0 auto;}
    		.sc_debug_body{background:#fff;border:4px double;padding:5px;}
    		.sc_debug_cap{font:bold 13px Tahoma;color:#fff;padding:5px;border:1px solid #000;width:250px;margin-top:-20px;}
    		.sc_debug_body .notice{background:#fdf403;color:#555;}
    		.sc_debug_body .warning{background:#f8b423;color:#555;}
    		.sc_debug_body .error{background:#c10505;color:#fff;}
    		.sc_debug_body .exception{background:#093dd3;color:#fff;}
    		.sc_debug_body .vardump{background:#333;color:#fff;}
